...
public class YassineQuickSort extends QuickSort {
	//***********************************************************************************************Code Added for Partition Method
	...
	**/
	...
	protected <T extends Comparable<T>> int partition(T[] table, int first, int last) {
		...
		System.out.println("");
		System.out.println("current first value: " + up);
		System.out.println("current last value: " + last);
		do {
			/* Invariant:
		...
		System.out.println("current pivot value: " + down);
		System.out.println("---- ");
		return down;
	}
	//***********************************************************************************************End of Code Added for Partition Method
}
